...
CREATE TABLE IF NOT EXISTS t_record (
  ...
  essay_graded TINYINT      NOT NULL DEFAULT 0         COMMENT 'essay是否已人工评分 0=待评 1=已评',
  graded_by    INT UNSIGNED          DEFAULT NULL      COMMENT '评分管理员ID(t_admin.id)',
  graded_at    TIMESTAMP             DEFAULT NULL      COMMENT '人工评分时间',
